...
SetDebuffSkill(nil,"assassins_mark",nil,"curse_assassins_mark",10)--暗影印记
...
SetDebuffSkill(nil,"fire_weakness",nil,"curse_fire_weakness",10)--易燃
SetDebuffSkill(nil,"cold_weakness",nil,"curse_cold_weakness",10)--冻伤
...
SetDebuffSkill(nil,"despair",nil,"curse_chaos_weakness",10)--绝望
...
AddUseSkillData(0,"凋零之步","slither")
...
--AddAttackSkillData("旋渦","Vortex",false)
--AddAttackSkillData("寒霜滲透","Creeping_Frost",false)
AddAttackSkillData("腐蝕毒雨",nil,true)
AddAttackSkillData("腐蝕箭矢",nil,true)
AddAttackSkillData("霸氣之擊",nil,false)
AddAttackSkillData("地裂陷阱",nil,false)
AddAttackSkillData("召喚憤怒狂靈",nil,true)
AddAttackSkillData("旋渦","Vortex",true)
AddAttackSkillData("寒霜滲透","Creeping_Frost",true)
AddAttackSkillData("爆裂陷阱","Explosive_Trap",true)
AddAttackSkillData("火球","Fireball",true)
AddAttackSkillData("抽血","Exsanguinate",true)
AddAttackSkillData("噴火陷阱","Flamethrower_Trap",true,nil,10)--黃怪
AddAttackSkillData("刀鋒陷阱","Fire_Trap",true)
AddAttackSkillData("冰凍陷阱","Fire_Trap",true)
