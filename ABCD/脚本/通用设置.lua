...
g_timeOut=28*60					--在一个地图呆的时间超过设置的 就重新开图重新 单位为秒
...
g_notHuanYaoLv=65				--大于等于多少级只捡蓝色以上药 
...
SetSaveIndex("异界地图","3")
SetSaveIndex("项链|戒指|爪|匕首|法杖|单手剑|细剑|单手斧|单手锤|符文匕首|短杖|战杖|弓|长杖|双手剑|双手斧|双手锤|腰带|手套|鞋子|头盔","2")
SetSaveIndex("主动技能宝石|辅助技能宝石|珠宝|命运卡|衣服|盾|箭袋|地图碎片","1")
...
SetGoodsCaoZuo("主动技能宝石|辅助技能宝石","0|2",nil,nil,nil,nil,21)--拾取品质超过5的技能宝石
...
SetGoodsCaoZuo(nil,"0|2","磨刀石","Metadata/Items/Currency/CurrencyWeaponQuality")--磨刀石不存
SetGoodsCaoZuo(nil,"0|2","护甲片","Metadata/Items/Currency/CurrencyArmourQuality")--护甲片不存
...
SetGoodsCaoZuo(nil,"3","普兰德斯金币","Metadata/Items/Currency/CurrencyPerandusCoin",nil,nil,nil,nil)
...
--SetGoodsCaoZuo(nil,"0|2","预言","Metadata/Items/Currency/CurrencyItemisedProphecy")
...
SetGoodsCaoZuo(nil,"0|2","拓印的封魔之玉","Metadata/Items/Currency/CurrencyItemisedCapturedMonster")--所有精华设置丢卖
